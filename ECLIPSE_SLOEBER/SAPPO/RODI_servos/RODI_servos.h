#define RODI_SERVOS_H_CARGADA

#define TIME_OFF_MS 180000 //Tiempo de desactivación automática de lectura de ultrasonidos en ms
...
#define AVANCE_MOTOR_DER	90 //  - = + rápido
#define AVANCE_MOTOR_IZQ	128 // + = + rápido

#define MIN_AVANCE_MOTOR_DER	102
#define MIN_AVANCE_MOTOR_IZQ	118

#define MIN_AVANCE_GIRO_MOTOR_DER	90
#define MIN_AVANCE_GIRO_MOTOR_IZQ	126

#define MIN_RET_MOTOR_DER	127
#define MIN_RET_MOTOR_IZQ	90

#define MIN_GIRO_MOTOR_DER		120
#define MIN_GIRO_MOTOR_IZQ		90
...
#define OP_MOTOR_PARAR 		1
#define OP_MOTOR_VEL 		2

#define MUESTREO_POSICION 	1
