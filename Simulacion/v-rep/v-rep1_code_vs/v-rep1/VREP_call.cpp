...
#define VELOCIDAD_ANGULAR			0.5
#define VELOCIDAD_ANGULAR_MIN		0.0001
#define DISTANCIA_SALTO_NODO		0.200 // 50cm
	...
	while (simxGetConnectionId(clientID) != -1) //Este bucle funcionara hasta que se pare la simulacion
	{
		...
		//Recuperamos la posición del robot
...
#define MAX_VALOR_OUT_PID	100
#define FACTOR_SALIDA	50
#define MAX_VEL_ANG		0.5	//Máxima diferencia de velocidad con corrección de trayectoria
#define MAX_VEL_FIJA	1	//Velocidad lineal sin corrección de trayectoria
#define MIN_VEL_FIJA	0.2 //Velocidad lineal con corrección de trayectoria
#define MIN_GRADOS_RECTA  8
